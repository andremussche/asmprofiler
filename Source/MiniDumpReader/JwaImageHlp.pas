...
//
  ...
  _MINIDUMP_STRING = record
    ...
    Buffer: array[0..0] of WCHAR; // Variable size buffer
  end;
...
//
  ...
  _MINIDUMP_MODULE = packed record
    BaseOfImage: ULONG64;
    SizeOfImage: ULONG32;
    CheckSum: ULONG32;
...
begin
  GetProcedureAddress(_MiniDumpWriteDump, DbgHelpLib, 'MiniDumpWriteDump');
  asm
        MOV     ESP, EBP
        POP     EBP
...
begin
  GetProcedureAddress(_MiniDumpReadDumpStream, DbgHelpLib, 'MiniDumpReadDumpStream');
  asm
        MOV     ESP, EBP
        POP     EBP
...
function MiniDumpWriteDump; external DbgHelpLib name 'MiniDumpWriteDump';
function MiniDumpReadDumpStream; external DbgHelpLib name 'MiniDumpReadDumpStream';
